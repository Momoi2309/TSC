...
# Load project
  ...
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/Number_of_Transaction=$2 -G/top/test/RND_CASE=$3 -G/top/test/seed=$4 -G/top/test/test_name=$5 top
...
if {[batch_mode] == 0} { #daca sunt in mod grafic
  eval log -r /*
  eval do wave.do
}
